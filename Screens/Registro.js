  ...
  return (
    <ImageBackground source={img}style = {styles.container}>
      <View style={styles.containerflecha}>
        ...
        <Image source={require("../img/flecha.jpeg")} style = {styles.flecha}></Image>
        </TouchableOpacity>
      </View>
    ...
    <View style={styles.logos}>
      <Image source={require('../img/facebook.jpeg')} style={styles.imagen}></Image>
      <Image source={require('../img/google.jpeg')} style={styles.imagen}></Image>
    </View>
    <TouchableOpacity style={styles.containerButton} onPress={() => navigation.navigate('DrawerNav')}>
