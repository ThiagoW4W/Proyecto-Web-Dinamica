...
function Blacklist({ navigation }) {
    ...
    return (
        <ImageBackground source={img}style = {styles.container}>
          ...
          <Text style = {styles.texto}>Blacklist</Text>
          <Text style = {styles.texto1}>Nuevo incidente </Text>
            ...
            <View style={styles.roperoContainer}>
              ...
              <TouchableOpacity style={styles.containerButton}>
                <Text style={styles.buttonText} onPress={() => navigation.navigate('Perfil')} >Guardar</Text>
              </TouchableOpacity>
            </View>
        </ImageBackground>
